...
## P1 — Redis-кэширование  `[ ]`  · Реш: ? (CODE рек.)  ⟵ главный пункт для защиты
...
## P2 — Redis как фоновые задачи/очередь  `[ ]`  · Реш: ? (DOC рек.)
...
## P4 — Аудит/журнал действий администратора  `[ ]`  · Реш: ?
